...
class Achievement extends StatefulWidget {
  const Achievement({
    ...
    required this.competitionImagePath,
    required this.achievementsAndRoles,
    required this.period,
  });

  final List <String> workDescription;
  final String competitionImagePath;
  final String achievementsAndRoles;
  final String period;
